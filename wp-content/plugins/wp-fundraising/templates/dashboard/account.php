...
<div class="tab-pane slideUp xs-dashboard" id="myAccount" role="tabpanel">
    <form action="#" method="POST" class="xs-campaign xs-dashboard-info">
        <h4 class="dashboard-content-title"><?php esc_html_e('Mi información','wp-fundraising');?></h4>
        <div class="row">
            <div class="col-lg-6">
                <div class="form-group">
                    <h3 class="h3"><?php esc_html_e('Usuario','wp-fundraising');?></h3>
        ...
        <div class="form-group">
            <h3 class="h3"><?php esc_html_e('Sitio Web','wp-fundraising');?></h3>
            <input type="url" disabled value="<?php echo $user_url; ?>" class="form-control">
        </div>
        <div class="form-group">
            <h3 class="h3"><?php esc_html_e('Biografia','wp-fundraising');?></h3>
    ...
    <form action="#" method="POST" id="myDashAccount" class="xs-campaign xs-dashboard-form">
        ...
        <div class="xs-btn-wraper">
            ...
            <input class="btn btn-success" type="submit" name="userUpdate" value="<?php esc_html_e('Guardar','wp-fundraising');?>" />
        </div>
