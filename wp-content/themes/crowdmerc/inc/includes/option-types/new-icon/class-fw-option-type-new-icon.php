...
class FW_Option_Type_NewIcon extends FW_Option_Type {
	...
	return fw_render_view(CROWDMERC_INC . '/includes/option-types/new-icon/view.php', compact('id', 'option', 'data', 'set'));
    }
	...
	return array(
	    ...
	    'container-class' => '',
	    'groups' => array(
		'unknown' => esc_html__('Unknown Set', 'crowdmarc'),
	    ),
	    'icons' => array(
	...
	return array(
		...
		'groups' => array(
		    'web-application' => esc_html__('Web Application Icons', 'crowdmarc'),
		    'hand' => esc_html__('Hand Icons', 'crowdmarc'),
		    'transportation' => esc_html__('Transportation Icons', 'crowdmarc'),
		    'gender' => esc_html__('Gender Icons', 'crowdmarc'),
		    'file-type' => esc_html__('File Type Icons', 'crowdmarc'),
		    'payment' => esc_html__('Payment Icons', 'crowdmarc'),
		    'currency' => esc_html__('Currency Icons', 'crowdmarc'),
		    'text-editor' => esc_html__('Text Editor Icons', 'crowdmarc'),
		    'directional' => esc_html__('Directional Icons', 'crowdmarc'),
		    'video-player' => esc_html__('Video Player Icons', 'crowdmarc'),
		    'brand' => esc_html__('Brand Icons', 'crowdmarc'),
		    'medical' => esc_html__('Medical Icons', 'crowdmarc'),
		    'crowdmarc-icon' => esc_html__('Crowdmerc Icons', 'crowdmerc'),
		),
		'icons' => array(
		    ...
		    //SeoPress Thimify Icons
            'icon icon-symbol xs-check-mark' => array('group' => 'crowdmarc-icon'),
            'icon icon-cogwheel-outline xs-check-mark' => array('group' => 'crowdmarc-icon'),
            'icon icon-shopping-cart xs-check-mark' => array('group' => 'crowdmarc-icon'),
            'icon icon-man xs-check-mark' => array('group' => 'crowdmarc-icon'),
            'icon icon-users2 xs-check-mark' => array('group' => 'crowdmarc-icon'),
            'icon icon-support xs-check-mark' => array('group' => 'crowdmarc-icon'),
            'icon icon-tool color-nBlue' => array('group' => 'crowdmarc-icon'),
            'icon icon-medical color-cBlue' => array('group' => 'crowdmarc-icon'),
            'icon icon-technology color-dOrange' => array('group' => 'crowdmarc-icon'),
            'icon icon-technology-1 color-pGreen' => array('group' => 'crowdmarc-icon'),
            'icon icon-brush color-eBlue' => array('group' => 'crowdmarc-icon'),
            'icon icon-music color-sBlue' => array('group' => 'crowdmarc-icon'),
            'icon icon-drink color-rRed' => array('group' => 'crowdmarc-icon'),
            'icon icon-tshirt color-tCotta' => array('group' => 'crowdmarc-icon'),
		),
	    ),
	);
    }
