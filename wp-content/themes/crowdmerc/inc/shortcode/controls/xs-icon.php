...
class Xs_Icon_Controler extends Elementor\Base_Data_Control {
	...
	public static function get_icons() {
		...
		$icons = array(
		    ...
		    'icon icon-tool color-nBlue' => 'icon color-nBlue',
		    'icon icon-medical color-cBlue' => 'icon color-cBlue',
		    'icon icon-technology color-dOrange' => 'icon color-dOrange',
		    'icon icon-technology-1 color-pGreen' => 'icon color-pGreen',
		    'icon icon-brush color-eBlue' => 'icon color-eBlue',
		    'icon icon-music color-sBlue' => 'icon color-sBlue',
		    'icon icon-drink color-rRed' => 'icon color-rRed',
		    'icon icon-tshirt color-tCotta' => 'icon color-tCotta',
		);
	...
	public function content_template() {
		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				<select class="elementor-control-icon" data-setting="{{ data.name }}" data-placeholder="<?php esc_attr_e( 'Select Icon', 'crowdmerc' ); ?>">
					<option value=""><?php esc_html_e( 'Select Icon', 'crowdmerc' ); ?></option>
